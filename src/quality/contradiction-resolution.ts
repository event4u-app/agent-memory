...
export async function resolveContradiction(
	...
	switch (strategy) {
		case "keep_a":
			...
			await entryRepo.transitionStatus(
				contradiction.entryBId,
				"rejected",
				`Contradiction resolved: keep A`,
				"human:resolution",
			);
			break;
		...
		case "keep_b":
			...
			await entryRepo.transitionStatus(
				contradiction.entryAId,
				"rejected",
				`Contradiction resolved: keep B`,
				"human:resolution",
			);
			break;
		...
		case "reject_both":
			...
			await entryRepo.transitionStatus(
				contradiction.entryAId,
				"rejected",
				`Contradiction resolved: reject both`,
				"human:resolution",
			);
			await entryRepo.transitionStatus(
				contradiction.entryBId,
	...
	logger.info({ contradictionId, strategy, kept, rejected }, "Contradiction resolved");
